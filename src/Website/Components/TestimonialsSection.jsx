...
export const TestimonialsSection = () => {
  ...
  return (
    <div 
      className="w-full bg-[#070707] py-12 md:py-16 overflow-hidden relative" 
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="text-center mb-10 md:mb-12">
          ...
          <div className="w-16 h-1 bg-orange-500 mx-auto mt-3 mb-4 rounded-full"></div>
        </div>

        {/* Compact Testimonial Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          
          {/* Left Side: Scaled Down Image Display */}
          <div className="lg:col-span-5 flex justify-center w-full">
            <div className="relative w-full max-w-[280px] sm:max-w-[320px] aspect-square group">
              ...
              {/* Main Image Holder */}
              <div className="w-full h-full bg-[#111] border border-white/10 rounded-xl overflow-hidden shadow-xl relative z-10">
                {imgUrl ? (
                  <img 
                    src={imgUrl} 
                  ...
                  <div className={`w-full h-full bg-gradient-to-br from-orange-600 via-rose-600 to-purple-700 flex items-center justify-center text-white font-black text-5xl md:text-6xl transition-all duration-500 ${isAnimating ? 'opacity-40 scale-95' : 'opacity-100 scale-100'}`}>
                    {initials}
                  </div>
                )}
                
                {/* Index Badge */}
                <div className="absolute bottom-4 left-4 bg-black/60 backdrop-blur-md px-3 py-1 rounded-lg border border-white/10 text-white/70 font-mono text-xs tracking-widest z-20">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center relative">
            ...
            <span className="absolute -top-10 -left-6 text-[8rem] md:text-[10rem] font-serif text-white/[0.03] select-none pointer-events-none leading-none">
              “
            </span>

            {/* Testimonial Core Content */}
            <div className={`transition-all duration-500 transform ${isAnimating ? 'opacity-0 translate-y-4 blur-sm' : 'opacity-100 translate-y-0 blur-0'}`}>
              ...
              <div className="flex gap-1 mb-4">
                {Array.from({ length: 5 }, (_, s) => (
                  <svg 
                    ...
                    className={`h-4 w-4 ${s < currentTestimonial.rating ? 'text-orange-500 drop-shadow-[0_0_6px_rgba(249,115,22,0.5)]' : 'text-white/10'}`} 
                    fill="currentColor" 
                    viewBox="0 0 24 24"
                  >
              ...
              {/* Text Statement */}
              <p className="text-lg md:text-2xl text-gray-200 font-medium leading-relaxed italic mb-6 tracking-wide">
              ...
              <div className="border-l-4 border-orange-500 pl-4 py-0.5">
                ...
                <span className="text-orange-500 text-xs font-bold tracking-widest uppercase block mt-0.5">
            ...
            <div className="flex items-center gap-3 mt-8 z-20">
              <button 
                ...
                className="w-11 h-11 rounded-full border border-white/10 bg-white/[0.02] text-white flex items-center justify-center transition-all duration-300 hover:bg-white hover:text-black hover:border-white disabled:opacity-40 disabled:pointer-events-none group active:scale-95"
