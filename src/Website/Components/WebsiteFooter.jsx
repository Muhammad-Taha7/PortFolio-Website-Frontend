    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 py-20 md:py-28">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 mb-20 pb-16 border-b border-white/10">
          ...
          <Link 
            to="/Contact" 
            className="inline-flex items-center justify-center px-8 py-4 bg-orange-500 hover:bg-orange-600 text-white font-bold rounded-full transition-all duration-300 uppercase tracking-widest hover:scale-105 hover:shadow-[0_0_30px_rgba(249,115,22,0.4)]"
          >
            Get In Touch
          </Link>
        </div>
      ...
      {/* Background Glow */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[400px] h-[200px] bg-orange-500/5 rounded-full blur-[100px] pointer-events-none"></div>
    </footer>
  );
};
